...
public class BuyersandSupplierssinglerecordadd
{
    ...
    public void AddBuyersandSuplliers() throws InterruptedException 
    {
        ...
        address1.sendKeys("Mornac Shreetdhar dsda geet Appt.");
        Thread.sleep(1000);
...
//    
    ...
    public void EditBuyersandSuplliers() throws InterruptedException 
    {
        ...
        eNameOfCompany.sendKeys("Tspatel Pvt Ltd");
        Thread.sleep(1000);
        ...
        eOfficialEmail.sendKeys("trishnapatel@gmail.com");
        Thread.sleep(1000);
    ...
    {
        BuyersandSupplierssinglerecordadd obj = new BuyersandSupplierssinglerecordadd();
        obj.chrome();
